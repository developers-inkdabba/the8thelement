...
export default function ResourcesPage() {
  return (
    <main className="bg-cream">
      <section className="pt-32 pb-14 lg:pb-28">
        <div className="w-full px-8 sm:px-12 lg:px-20">
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              What&apos;s Happening With Your Body Right Now?
            </h1>
            <p className="mx-auto max-w-3xl text-muted text-xl leading-relaxed mb-5">
              A quick Perimenopause Quiz to help you understand your symptoms and where you may be
              in your menopause transition.
            </p>
            <p className="mx-auto max-w-3xl text-dark text-lg font-semibold leading-relaxed mb-10">
              Get a personalised report with practical next steps based on your responses.
            </p>
            <Link
              href="/quiz"
          ...
          <div className="mx-auto max-w-4xl text-center">
            <div>
              ...
              <p className="text-muted text-lg leading-relaxed">
                Watch women share what changed for them through coaching.
              </p>
            </div>
            <Link
